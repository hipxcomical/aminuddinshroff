              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-x-16 mt-16">
                ...
                <div className="lg:col-span-2 flex flex-col space-y-16">
                    <AnimatedSection className="flex-grow flex flex-col">
                        <div className="bg-gray-50/80 p-8 md:p-12 rounded-lg shadow-sm flex-grow">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {skillsData.flatMap(category => category.skills).map((skill) => {
                                    ...
                                    const isAnotherSkillHovered = hoveredSkill !== null && !isHovered;
                                    return (
                                        <button 
                                            key={skill.id} 
                                            onClick={() => setSelectedSkill(skill)}
                                            className={`bg-orange-100 text-brand-orange px-4 py-2 rounded-full text-base font-semibold transition-all duration-300 ease-in-out cursor-pointer
                                                ${isHovered ? 'bg-brand-orange text-white scale-110 shadow-lg' : ''}
                                                ${isAnotherSkillHovered ? 'opacity-40' : 'opacity-100'}
              ...
              <div className="mt-16">
                  <Section title="Connect">
                     <div className="flex flex-wrap items-center justify-center gap-8">
                        ...
                        <a href="https://drive.google.com/file/d/1OTXTfKo0b3mQU7WfPFuSStukqUK9RwTQ/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-block bg-gray-700 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-300 hover:bg-gray-900 text-xl">
                            Download PDF
                        </a>
