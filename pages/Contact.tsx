  ...
  return (
    <div className="w-full mx-auto px-8 md:px-16 lg:px-24 pb-16 md:pb-24">
      <AnimatedSection>
        ...
        <AnimatedSection>
            <div className="bg-gray-50/80 p-8 md:p-12 rounded-lg shadow-sm text-center max-w-3xl mx-auto mb-10">
                ...
                <a
                  ...
                  className="inline-block w-full sm:w-auto bg-brand-orange text-white font-bold py-4 px-10 rounded-md transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 text-lg"
                >
                    Book an Appointment
                </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
                ...
                <div className="bg-gray-50/80 p-8 rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col text-center h-full">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="inline-flex items-center justify-center bg-verizon-red text-white font-bold py-3 px-6 rounded-md transition-opacity duration-300 hover:opacity-90 mt-auto"
                    >
                 ...
                 <div className="bg-gray-50/80 p-8 rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col text-center h-full">
                    ...
                    <a href="https://www.linkedin.com/in/aminuddinshroff/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-linkedin-blue text-white font-bold py-3 px-6 rounded-md transition-opacity duration-300 hover:opacity-90 mt-auto">
